...
openssl req -new -key $D/tls.onstage.key -passin file:$D/tls.onstage.pw -out $D/tls.onstage.csr -subj "/C=US/ST=CA/L=San Francisco/O=Red Hat Inc./CN=inter-router-demo2-amq.apps.summit.sysdeseng.com"
